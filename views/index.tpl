...
<div class="top-bar">
    <div>
        <div class="top-bar-left">
            <ul class="dropdown menu" data-dropdown-menu="kpc8rx-dropdown-menu" role="menubar" aria-expanded="false" data-is-click="false">
        ...
        <div class="top-bar-right">
            <ul class="menu">
                <li><input type="search" placeholder="Search Stickers"></li>
